# Fine-tuned Research: Adds recency constraints and smarter research handling
...
class RouterDecision(BaseModel):
    ...
    max_results_per_query: int = Field(
        5, description="How many results to fetch per query (3–8).")
...
# Router Node with recency handling
...
# Route next step based on research
...
def run(topic: str, as_of: Optional[str] = None):
    ...
    if out.get("evidence"):
        print("EVIDENCE_SAMPLE:", [e.model_dump()
              for e in out["evidence"][:2]])
